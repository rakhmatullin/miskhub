...
(function(){
  ...
  function extras(){
    return boot('./akty.cloud.js?v=16').then(function(t){ inject(t); return boot('./akty.overlay.js?v=16'); }).then(function(t){ inject(t); });
  }
  function tryParts(){
    return Promise.all([1,2,3,4,5,6].map(function(n){ return boot('./engine/e'+n+'.js?v=16'); }))
      .then(function(arr){ var t=arr.join(''); if(t.length<20000) throw new Error('short parts'); inject(t); });
  }
