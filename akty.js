...
(function(){
  ...
  function extras(){
    return boot('./akty.cloud.js?v=19').then(function(t){ inject(t); return boot('./akty.overlay.js?v=19'); }).then(function(t){ inject(t); });
  }
  var sources = ['https://litter.catbox.moe/6akequ.js','https://raw.githubusercontent.com/rakhmatullin/miskhub/c8a3471705530114db4947ec60574dae7766e3e4/akty.engine.js'];
  (function next(i){
